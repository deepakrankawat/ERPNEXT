...
class TestLexocratesTheme(FrappeTestCase):
	...
	def test_branding_and_chat_responsive_contract(self):
		...
		self.assertIn("lexocrates-logo-dark.svg", staff_login)
		self.assertIn("lexocrates-logo-dark.svg", client_login)
		self.assertNotIn("lexocrates-mark-dark.png", staff_login)
		self.assertNotIn("lexocrates-mark-dark.png", client_login)
		self.assertIn("height: 58px;", staff_login)
		self.assertIn("height: 58px;", client_login)
